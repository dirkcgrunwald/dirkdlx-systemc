...
sc_main(int argc, char **argv)
{
  ...
  Pipelined_ID stage_id("decode_stage");
  stage_id.debug = debug;

  Pipelined_EX stage_ex("exec_stage");
  stage_ex.debug = debug;

  Pipelined_MEM stage_mem("memory_stage");
  stage_mem.debug = debug;

  Pipelined_WB stage_wb("writeback_stage");
